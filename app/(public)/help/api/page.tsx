                                        ...
                                        return (
                                                            <div className="space-y-6 pb-12 px-6">
                                                                                ...
                                                                                <div className="space-y-12">
                                                                                                    <section id="raycasting" className="space-y-4">
                                                                                                                        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">
                                                                                                                                            RaycastService
                                                                                                                        </h3>
                                                                                                                        <p className="leading-7">Convert a screen tap into a world position.</p>
...
let worldPoint = raycastService.worldPoint(fromX: x, y: y)`}
                                                                                                    ...
                                                                                                    <section id="distance" className="space-y-4">
                                                                                                                        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">
                                                                                                                                            DistanceCalculator
                                                                                                                        </h3>
                                                                                                                        <p className="leading-7">Calculate distance between two 3D points.</p>
                                                                                                                        <div className="relative rounded-lg bg-zinc-950 px-4 py-4 dark:bg-zinc-900">
                                                                                                                                            <pre className="overflow-x-auto">
                                                                                                                                                                <code className="relative rounded font-mono text-sm text-zinc-50">
    ...
    color: .white
                    ...
                    return (
                                        <div className="space-y-6 pb-12 px-6">
                                                            <DocPageHeader
                                                                                heading="API Reference"
                                                                                text={`Detailed documentation for the ${platform === 'react-native' ? 'React Native' : 'Kotlin'} SDK.`}
                                                            />
