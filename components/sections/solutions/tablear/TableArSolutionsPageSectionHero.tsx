...
export default function TableArSolutionsPageSectionHero() {
  return (
    <GlowSection
        ...
        <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="max-w-[600px]">
            ...
            <p className="mt-8 max-w-[560px] text-[16px] leading-8 text-[#111827]/75">
              Table-AR is a mobile AR toolkit for tabletop RPGs and miniature
              wargames, providing real-time distance measurement, area
              calculations, and initiative tracking—bringing analog gameplay
              into the digital age without losing its tactile charm.
            </p>

            <div className="mt-10">
              <Link
                href="https://apps.apple.com/us/app/table-ar/id6756374363"
